        ...
        <div class="col-sm-9 col-md-10 main">
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        <c:forEach items="${p.list}" var="i">
                            <tr>
                                ...
                                <td>${i.buyingTime}</td>
                                <td>
                                    <a href="/usermanage/downloadfile/${i.programFile}">${i.programFile}
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <div  style="align-content: right">
                      <span >
                            <a href="/usermanage/customerhistory?page=${p.first}&qiYeId=1">首页</a>
                            <c:if test="${p.hasPre()}">
                                <a href="/usermanage/customerhistory?page=${p.pre}&qiYeId=1" >上一页</a>
                            </c:if>
                        </span>
                            ...
                            <span>
                                ...
                                <c:if test="${!p.isCurrent(i)}">
                                                    <span class="paginate_button ">
                                                         <a href="/usermanage/customerhistory?page=${i}&qiYeId=1">第${i}页</a>
                                                    </span>
                                </c:if>
                            </span>
                        </c:forEach>
                        ...
                        <span>
                            ...
                            <c:if test="${(p.hasNext())}">
                                <a href="/usermanage/customerhistory?page=${p.next}&qiYeId=1">下一页</a>
                            </c:if>
                            <a href="/usermanage/customerhistory?page=${p.last}&qiYeId=1">尾页</a>
                        </span>
